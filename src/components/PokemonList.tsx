...
export default function PokemonList() {
  ...
  return (
    <>
      <div className="w-full 2xl:w-[800px]  sm:bg-red-500 lg:bg-green-600 h-[400px] md:h-[500px] lg:h-[700px] flex justify-center items-center lg:px-10 lg:mt-10">
        {pokemons.count ? (
          <>
            <div className="grid grid-cols-5 gap-1 lg:gap-x-25 xl:gap-x-10  mx-auto place-items-center py-2 2xl:px-16 xl:px-0">
             {pokemons.results.map((pokemon) => (
                ...
                <button
                  key={pokemon.id}
                  className="w-25 h-25 sm:w-26 sm:h-26 xl:w-30 xl:h-30 bg-[rgb(216,233,244)] rounded-xl hover:scale-105 transition-all duration-200 flex justify-center items-center pokeshadow"
                  onClick={() =>
                    mostrarEnPokedex(
                      pokemon.imageUrl,
                      pokemon.name,
